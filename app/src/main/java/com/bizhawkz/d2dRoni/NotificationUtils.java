...
public class NotificationUtils {
    ...
    public void showNotificationMessage(final String title, final String message, final String timeStamp, Intent
            intent, String imageUrl) {
    ...
    private void showSmallNotification(NotificationCompat.Builder mBuilder, int icon, String title, String message, String timeStamp, PendingIntent resultPendingIntent) {
        ...
        notification = mBuilder.setSmallIcon(icon).setTicker(title).setWhen(0)
                ...
                .addAction (R.drawable.view,"View", resultPendingIntent)
                 .build();
