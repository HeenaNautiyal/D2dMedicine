...
public class FirstAid1 extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    String mail1, quan;
    String chemmail;
    TextView tv, medicine, composition, description, manufacture, mCounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=27&catid=33");
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < countryList.size(); i++) {
                    ...
                    if (actors.getSelected()) {
                        ...
                        if (abcd >= 1) {
                            Intent intent = new Intent(FirstAid1.this, Ordernow.class);
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText.isEmpty()) {
            ...
            adapter2.clearData();
            new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=15&cat_id=33&medicine=" + newText + "");
            adapter2.notifyDataSetChanged();
        }
        return false;
    }
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(FirstAid1.this);
