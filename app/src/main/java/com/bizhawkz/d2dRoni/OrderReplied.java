...
public class OrderReplied extends AppCompatActivity  {
    ...
    String flag,stock,name,mail,chemmail,eddate1,message,orderid,medicine,eddate2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                eddate1=eddate2;
                if (flag=="2") {
                    message="This%20medicineis%20out%20of%20stock";
                  //  System.out.println("message: "+message);
                    new nofication().execute();
                               }
                else{
                    message="Your%20order%20id%20"+orderid+"%20has%20been%20deliver%20till%20"+eddate1;
                  //  System.out.println("message: "+message);
                    new nofication().execute();
                }
            }
        ...
        fromDatePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                eddate.setText(dateFormatter.format(newDate.getTime()));
                 eddate2=dateFormatter.format(newDate.getTime());
            }
