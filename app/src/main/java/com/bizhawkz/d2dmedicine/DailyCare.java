...
public class DailyCare extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=27&catid=30");
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < countryList.size(); i++) {
                    ...
                    if (actors.getSelected()) {
                        ...
                        if (abcd >= 1) {
                            Intent intent = new Intent(DailyCare.this, Ordernow.class);
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText.isEmpty()){
            ...
            adapter2.clearData();
            new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=15&cat_id=30&medicine=" + newText + "");
            adapter2.notifyDataSetChanged();
        }
        return false;
    }
