...
public class OTCCounter extends AppCompatActivity implements SearchView.OnQueryTextListener {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < countryList.size(); i++) {
                    ...
                    if (actors.getSelected()) {
                        ...
                        if (abcd >= 1) {
                            Intent intent = new Intent(OTCCounter.this, Ordernow.class);
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText.isEmpty()){
            ...
            adapter2.clearData();
            new JSONAsyncTask().execute("http://d2dmedicine.com/aPPmob_lie/insertdata.php?caseid=15&cat_id=27&medicine=" + newText + "");
            adapter2.notifyDataSetChanged();
        }
        return false;
    }
